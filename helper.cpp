...
iso_obj iso_get_prop(double targ_feh, double targ_propMi, double targ_logAge, vector<iso_obj> &isochrones)
{
	int feh_line1, feh_line2;
	int age_line1, age_line2;
	int mass_line;
	...
	if (targ_feh<-0.914 || targ_feh>0.417 || targ_propMi<0. || targ_propMi>1. || targ_logAge<7.05 || targ_logAge>10.25)
	{
		throw (5);
	}
...
//	if (isochrones[feh_line1+age_line1].Mi>targ_propMi*isochrones[feh_line1+age_line1+599].Mi || isochrones[feh_line1+age_line2].Mi>targ_propMi*isochrones[feh_line1+age_line2+599].Mi ||
//	    isochrones[feh_line2+age_line1].Mi>targ_propMi*isochrones[feh_line2+age_line1+599].Mi || isochrones[feh_line2+age_line2].Mi>targ_propMi*isochrones[feh_line2+age_line2+599].Mi )
//	{
//		throw (6);
//	}
	...
	if (targ_propMi<0.92)
	{
		mass_line=floor(300*(targ_propMi/0.92));
		mass_weight=300*(targ_propMi/0.92) - mass_line;
	}
	else
	{
		mass_line=300 + floor(300*(targ_propMi - 0.92)/0.08);
		mass_weight=300 + 300*(targ_propMi - 0.92)/0.08 - mass_line;
	}
	...
	if (r1<-10||i1<-10||ha1<-10){throw(7);}
	iso_obj new_iso(targ_feh, targ_propMi, targ_logAge, 0., 0., r1, i1, ha1);
