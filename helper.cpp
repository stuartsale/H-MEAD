...
iso_obj iso_get_Tg(double targ_feh, double targ_logT, double targ_logg, vector<iso_obj> &isochrones)
{
	...
	Mi1+=(1-feh_weight)*(1-logT_weight)*(1-logg_weight) * isochrones[feh_line1+logT_line2+logg_line].Mi
	  + (1-feh_weight)*(1-logT_weight)*(logg_weight) * isochrones[feh_line1+logT_line2+logg_line+1].Mi;
	logAge1+=(1-feh_weight)*(1-logT_weight)*(1-logg_weight) * isochrones[feh_line1+logT_line2+logg_line].logAge
	  + (1-feh_weight)*(1-logT_weight)*(logg_weight) * isochrones[feh_line1+logT_line2+logg_line+1].logAge;
	...
	Mi1+=(1-feh_weight)*(1-logT_weight)*(1-logg_weight) * isochrones[feh_line2+logT_line1+logg_line].Mi
	  + (1-feh_weight)*(1-logT_weight)*(logg_weight) * isochrones[feh_line2+logT_line1+logg_line+1].Mi;
	logAge1+=(1-feh_weight)*(1-logT_weight)*(1-logg_weight) * isochrones[feh_line2+logT_line1+logg_line].logAge
	  + (1-feh_weight)*(1-logT_weight)*(logg_weight) * isochrones[feh_line2+logT_line1+logg_line+1].logAge;
	...
	Mi1+=(1-feh_weight)*(1-logT_weight)*(1-logg_weight) * isochrones[feh_line2+logT_line2+logg_line].Mi
	  + (1-feh_weight)*(1-logT_weight)*(logg_weight) * isochrones[feh_line2+logT_line2+logg_line+1].Mi;
	logAge1+=(1-feh_weight)*(1-logT_weight)*(1-logg_weight) * isochrones[feh_line2+logT_line2+logg_line].logAge
	  + (1-feh_weight)*(1-logT_weight)*(logg_weight) * isochrones[feh_line2+logT_line2+logg_line+1].logAge;
