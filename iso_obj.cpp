...
*/
	u=(0.00051868526*(r0-i0)-0.0029977593) /1.08573;						// 2nd order on r 				
	v=(-0.03202578*(r0-i0)+1.1109227) /1.08573;							// 1st order on r
	w=(0.0028546092*(r0-i0)+0.0048040543) /1.08573;							// 0th order on r	

	u_i=(0.0001234*(r0-i0)-0.001616) /1.08573;
	v_i=(-0.014138594*(r0-i0)+0.8480197) /1.08573;
	w_i=(0.000120494*(r0-i0)+0.0016170746) /1.08573;

	u_ha=(0.000021304992*(r0-i0)-0.000029709503) /1.08573;
	v_ha=(0.00016239351*(r0-i0)+1.0192878) /1.08573;
	w_ha=(-0.0007983722*(r0-i0)+0.0004974765) /1.08573;
